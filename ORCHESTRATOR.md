...
- **🛑 APPROVAL GATE**: Display PRD summary. **STOP HERE. Wait for User Approval.**
...
- **🛑 APPROVAL GATE**: Display Tech Spec summary. **STOP HERE. Wait for User Approval.**
...
- **🛑 APPROVAL GATE**: Final Release Sign-off. **STOP HERE. Wait for User Approval.**
