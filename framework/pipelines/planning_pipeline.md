...
### Stage P3: [Handoff to Orchestrator: Phase 1 Approval Gate] 🛑
*Planning Constraint:* Do not proceed to Technical Specification. Yield control back to `ORCHESTRATOR.md` to enforce the global LLM Hard Stop. Await explicit User Approval of the PRD.
...
### Stage P7: [Handoff to Orchestrator: Phase 2 Approval Gate] 🛑
*Planning Constraint:* Do not proceed to Implementation Planning or Analysis. Yield control back to `ORCHESTRATOR.md` to enforce the global LLM Hard Stop. Await explicit User Approval of the Tech Spec.
...
|------|-------|-----------|-----------------|
| PRD Approval | P3 | User reviews PRD | [Orchestrator Handoff] |
| Tech Spec Approval | P7 | User reviews Tech Spec | [Orchestrator Handoff] |

The Orchestrator must enforce explicit written user confirmation at each gate. Implicit or assumed approval is not accepted.
