...
- **QA Engineer A** → `../skills/responsive.md` (responsive behavior across all breakpoints).
- **QA Engineer B** → `../skills/accessibility.md` (WCAG AA compliance across all components).
- **PR Auditor** → `../skills/code_review.md` (architecture, quality, maintainability).
- **UI Reviewer** → `../skills/design_review.md` (pixel accuracy vs. Design Specification — spawned only if design was provided).
...
| Stage | Agent | Skill |
|-------|-------|-------|
| V2 | QA Engineer | `../skills/responsive.md` |
| V2 | QA Engineer | `../skills/accessibility.md` |
| V2 | PR Auditor | `../skills/code_review.md` |
| V2 | UI Reviewer | `../skills/design_review.md` (conditional) |
...
|-------|----------------|--------|
| `../skills/responsive.md` | Layout at all breakpoints | 25% |
| `../skills/accessibility.md` | WCAG AA compliance | 25% |
| `../skills/code_review.md` | Architecture and quality | 25% |
| `../skills/design_review.md` | Pixel-accurate UI | 25% |
